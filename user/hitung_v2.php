...
$cost_values = []; // Untuk menyimpan nilai biaya
...
foreach ($results as $alternative) {
    if ($alternative['nama_alternatif'] !== 'min_max') { // Abaikan baris min_max
        ...
        $cost_values[] = $alternative['C1'];
        $cost_values[] = $alternative['C2'];
    }
}
...
foreach ($results as $alternative) {
    if ($alternative['nama_alternatif'] !== 'min_max') { // Abaikan baris min_max
        $normalized_data[] = [
            ...
            'C1' => 1 / $alternative['C1'], // normalisasi untuk cost (Rumus 1)
            'C2' => 1 / $alternative['C2'], // normalisasi untuk cost (Rumus 1)
