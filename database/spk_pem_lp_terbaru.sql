...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2025 at 02:45 PM
...
(71, 'A9', 'RMQ7+2W6, Jl. Prof. Dr. Herman Johanes, Penfui, Kec. Kupang Tengah, Kabupaten Kupang, Nusa Tenggara Tim.', '-10.15239467422181', '123.66531600041164', '9fdae91062f4ea105a7ccff5c9190215.jpg'),
(72, 'A8', '8X38+C5V, Unnamed Road, Lelogama, Amfoang Sel., Nusa Tenggara Tim., Lelogama, Kec. Amfoang Sel., Kabupaten Kupang, Nusa Tenggara Tim.', '-9.696149742645233', '123.96539981128755', 'd260a15564278cf1c5692d7fde2d6cc9.JPG'),
(73, 'A7', 'RJR8+749, Unnamed Road, Oebufu, Oebobo, Kupang City, East Nusa Tenggara 85228', '-10.159139588445775', '123.61537169824815', '97dda75f3beaf5c70380bf2f4abacaec.jpg'),
(74, 'A6', 'VM85+7RP Pantai Nunsui, Oesapa, Lasiana, Kelapa Lima, Kupang City, East Nusa Tenggara', '-10.13399437531897', '123.65977131412339', '993b760b9f52a61fd05d6bedfa241c1e.jpg'),
(75, 'A5', 'Tablolong, Kec. Kupang Bar., Kabupaten Kupang, Nusa Tenggara Tim.', '-10.317648084569043', '123.47524089721787', 'b8de5bcba3281948aa7455535ca93fa1.jpg'),
(76, 'A4', 'JPVR+9Q6, Unnamed Road, Erbaun, Amarasi Bar., Nusa Tenggara Tim., Erbaun, Amarasi Barat, Kupang Regency, East Nusa Tenggara', '-10.356365398345398', '123.74187629805868', 'c862d8670e58d45d2e27238c3c0d7f9e.JPG'),
(77, 'A3', 'PJXM+RGX, Oelomin, Kec. Maulafa, Kabupaten Kupang, Nusa Tenggara Tim.', '-10.250241115332338', '123.63387815626729', 'e9e01fbd192b2b8d8d60f4e092e28186.jpg'),
(78, 'A2', 'Jl. Ikan Tongkol, Lahilai Bissi Kopan, Kec. Kota Lama, Kota Kupang, Nusa Tenggara Tim.', '-10.16110126732182', '123.57682697358145', '6a99d4c3ba0f85d09d910882cee48c06.jpg'),
(79, 'A1', 'Jl jurusan Bendungan, Raknamo, Kec. Amabi Oefeto, Kabupaten Kupang, Nusa Tenggara Tim.', '-10.119112685751425', '123.93217902292075', '7dd79a50a90ec2fcdafc93c9be8f975a.jpg'),
(80, 'A0', 'Buraen, Kec. Amarasi Sel., Kabupaten Kupang, Nusa Tenggara Tim.', '-10.308819154490156', '123.87415102895896', '37a569cdb42b93c83bcbe6368fb8c232.JPG'),
(83, 'A10', '-', '-9.865149346683376', '124.30736676601288', '883916d19be1305cc9755462805c6e20.png'),
(84, 'A11', '-', '-9.566116506971282', '124.30736676601288', '6f8e08cf60b3cb9c2e1a6886bba679dc.png'),
(85, 'A12', '-', '-9.566116506971282', '124.41281113776452', '965d7051afb1c22733bc8a8190345bf2.png');
...
--
ALTER TABLE `alternatif`
  MODIFY `id_alternatif` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;

--
-- AUTO_INCREMENT for table `kecocokan_alt_kriteria`
--
ALTER TABLE `kecocokan_alt_kriteria`
  MODIFY `id_alt_kriteria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
